                  ...
                  <table id="mytable" class="table table-striped w-100">
                    <thead class="table-dark">
                      <tr>
                        ...
                        <th class="text-white">DATE VENTE</th>
                    ...
                    <tbody class="table-light">
                      ...
                      foreach($get_data as $item):
                        ...
                        $nbr_casier_value='<small class="text-muted">('.number_format($nbr_casier, 0, ',', ' ').' casier'.$bt.')</small>';
                        if($nbr_casier==1 && $qte<$item->NBR_BOUTEILLE_PAR_CASIER)
                        {
                          $nbr_casier_value='';
                        }
                      ?>
                        <tr>
                          ...
                          <td><span class="badge bg-dark text-white"><?= $item->QTE ?></span> <?=$nbr_casier_value?> </td>

                          <td><?= number_format($item->PU, 2, ',', ' ') ?> Fbu</td>

                          <td><?= number_format($item->PT, 2, ',', ' ') ?> Fbu</td>
